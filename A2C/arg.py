...
def init_parser(alg):
    ...
    if alg == 'Reinforce':
        ...
        parser.add_argument('--test_size', type=int, default=0.02, help='')
        ...
        parser.add_argument('--share_lr', type=float, default=0.0001, help='learning rate.')
        ...
        parser.add_argument('--net_seed', default=47, type=int, help='')
        parser.add_argument('--info', type=bool, default=True, help='')
        parser.add_argument('--selling_length', default=200, type=int, help='the length of selling season')
        ...
        parser.add_argument('--num_products', default=57, type=int, help='')
        parser.add_argument('--number_samples', default=10000, type=int, help='')
        parser.add_argument('--num_cus_types', default=4, type=int, help='')
        parser.add_argument('--seg_prob', default=[0.25,0.256,0.244,1-0.25-0.256-0.244], type=list, help='')
        parser.add_argument('--num_cus_features', default=4, type=int, help='')

        parser.add_argument('--p_file', default='../Gene_databeta/save/expedia_prop_features.npy', type=str, help='product file')
        return parser
