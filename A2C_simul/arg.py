...
def init_parser(alg):
    ...
    if alg == 'Reinforce':
        ...
        parser.add_argument('--h', default=1, type=int, help='hidden layer')#2
        parser.add_argument('--w', nargs='+', default=[120,50], type=int)#80
        ...
        parser.add_argument('--A2C', type=bool, default=False, help='train A2C')
        parser.add_argument('--SQ', type=bool, default=True, help='train slate Q')
        ...
        parser.add_argument('--net_seed', default=10, type=int, help='')
        parser.add_argument('--seed', default=0, type=int, help='')
        parser.add_argument('--info', type=bool, default=True, help='')
        parser.add_argument('--selling_length', default=100, type=int, help='the length of selling season')
        ...
        parser.add_argument('--num_cus_features', default=4, type=int, help='')
        parser.add_argument('--MNLdata', default=10000, type=int, help='')
        
        parser.add_argument('--p_file', default='../Gene_databeta/simul/p10_random.npy', type=str, help='product file')
        parser.add_argument('--c_file', default='../Gene_databeta/simul/c4_random.npy', type=str, help='customer file')
        return parser
