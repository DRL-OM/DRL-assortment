...
def init_parser(alg):
    ...
    if alg == 'Reinforce':
        ...
        parser.add_argument('--share_lr', type=float, default=0.005, help='learning rate.')
        parser.add_argument('--actor_lr', type=float, default=0.005, help='learning rate.')
        parser.add_argument('--critic_lr', type=float, default=0.01, help='learning rate.')
        parser.add_argument('--step', type=float, default=50, help='learning rate decay step.')
